...
COPY umqtt /micropython/ports/esp8266/modules/umqtt
# COPY uasyncio /micropython/ports/esp8266/modules/uasyncio
...
COPY webresources.py /micropython/ports/esp8266/modules/
